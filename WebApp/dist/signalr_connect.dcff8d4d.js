...
function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            this.logger.log(_ILogger.LogLevel.Warning, "Error from HTTP request. " + e_1 + ".");
            throw e_1;
          ...
          case 6:
            ...
            return [2
            /*return*/
            , new _HttpClient.HttpResponse(response.status, response.statusText, payload)];
        }
      });
    });
  };
  ...
  FetchHttpClient.prototype.getCookieString = function (url) {
    ...
    if (_Utils.Platform.isNode && this.jar) {
...
function (_super) {
  ...
  function DefaultHttpClient(logger) {
    ...
    if (typeof fetch !== "undefined" || _Utils.Platform.isNode) {
      _this.httpClient = new _FetchHttpClient.FetchHttpClient(logger);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            if (this.connectionState !== HubConnectionState.Reconnecting) {
              this.logger.log(_ILogger.LogLevel.Debug, "Connection moved to the '" + this.connectionState + "' from the reconnecting state during reconnect attempt. Done reconnecting."); // The TypeScript compiler thinks that connectionState must be Connected here. The TypeScript compiler is wrong.
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            _b = (0, _Utils.getUserAgentHeader)(), name = _b[0], value = _b[1];
  ...
  LongPollingTransport.prototype.send = function (data) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        return [2
        /*return*/
        , (0, _Utils.sendMessage)(this.logger, "LongPolling", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent, this.withCredentials, this.headers)];
      });
    });
  };
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            headers = {};
            _a = (0, _Utils.getUserAgentHeader)(), name_1 = _a[0], value = _a[1];
          ...
          case 2:
            ...
            , new Promise(function (resolve, reject) {
              ...
              if (_Utils.Platform.isBrowser || _Utils.Platform.isWebWorker) {
                ...
                var _a = (0, _Utils.getUserAgentHeader)(),
                    name_1 = _a[0],
                    value = _a[1];
  ...
  ServerSentEventsTransport.prototype.send = function (data) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        return [2
        /*return*/
        , (0, _Utils.sendMessage)(this.logger, "SSE", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent, this.withCredentials, this.headers)];
      });
    });
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            _a = (0, _Utils.getUserAgentHeader)(), name = _a[0], value = _a[1];
            headers[name] = value;
  ...
  HttpConnection.prototype.constructTransport = function (transport) {
    switch (transport) {
      case _ITransport.HttpTransportType.WebSockets:
        ...
        return new _WebSocketTransport.WebSocketTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || false, this.options.WebSocket, this.options.headers || {});
      ...
      case _ITransport.HttpTransportType.ServerSentEvents:
        ...
        return new _ServerSentEventsTransport.ServerSentEventsTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || false, this.options.EventSource, this.options.withCredentials, this.options.headers || {});

      case _ITransport.HttpTransportType.LongPolling:
        return new _LongPollingTransport.LongPollingTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || false, this.options.withCredentials, this.options.headers || {});
...
function simulate() {
  var simulateUrl = "http://localhost:7071/api/Simulate"; // var simulateUrl = "https://smarthighwayfunctionapp.azurewebsites.net/api/Simulate?";
...
},{"@microsoft/signalr":"node_modules/@microsoft/signalr/dist/esm/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","signalr_connect.js"], null)
//# sourceMappingURL=/signalr_connect.dcff8d4d.js.map